...
public class RecipesFuser
{
	...
	private RecipesFuser()
	{
		...
		// addRecipe(new ShapedFuserRecipe(ItemsLT.ELEMENTAL_PICKAXE, "fff", " t
		// ", " w ", 'f', EnumMultiMaterialType.FIERY_CRYSTAL, 't',
		// ItemsLT.THAUMIUM_PICKAXE, 'w',
		// EnumMultiMaterialType.ENCHANTED_WOOD).setVisUsage(5,
		// 0).setResearch(ResearchesLT.ELEMENTAL_PICKAXE));
		// addRecipe(new ShapedFuserRecipe(ItemsLT.ELEMENTAL_AXE, "ff", "ft", "
		// w", 'f', EnumMultiMaterialType.AQUEOUS_CRYSTAL, 't',
		// ItemsLT.THAUMIUM_AXE, 'w',
		// EnumMultiMaterialType.ENCHANTED_WOOD).setVisUsage(10.5F,
		// 0).setResearch(ResearchesLT.ELEMENTAL_AXE).setMirrored(true));
		// addRecipe(new ShapedFuserRecipe(ItemsLT.ELEMENTAL_SWORD, " v ",
		// "vtv", " w ", 'v', EnumMultiMaterialType.VAPOROUS_CRYSTAL, 't',
		// ItemsLT.THAUMIUM_SWORD, 'w',
		// EnumMultiMaterialType.ENCHANTED_WOOD).setVisUsage(10.5F,
		// 0).setResearch(ResearchesLT.ELEMENTAL_SWORD));
		// addRecipe(new ShapedFuserRecipe(ItemsLT.ELEMENTAL_SHOVEL, " v ",
		// "vtv", " w ", 'v', EnumMultiMaterialType.EARTHEN_CRYSTAL, 't',
		// ItemsLT.THAUMIUM_SHOVEL, 'w',
		// EnumMultiMaterialType.ENCHANTED_WOOD).setVisUsage(10.5F,
		// 0).setResearch(ResearchesLT.ELEMENTAL_SHOVEL));
		...
		// addRecipe(new ShapedFuserRecipe(BlocksLT.VIS_PURIFIER, "geg", "ses",
		// "geg", 'g', "ingotGold", 'e',
		// EnumMultiMaterialType.ENCHANTED_SILVERWOOD, 's',
		// BlocksLT.SILVERWOOD_LOG).setResearch(ResearchesLT.VIS_PURIFIER).setVisUsage(1.25F,
		// 3.5F));
		addRecipe(new ShapelessFuserRecipe(Items.BLAZE_POWDER, EnumMultiMaterialType.CINDERPEARL_POD));
		// addRecipe(new ShapedFuserRecipe(BlocksLT.CRYSTALLIZER, "123", "456",
		// "787", '1', EnumMultiMaterialType.VAPOROUS_CRYSTAL, '2',
		// EnumMultiMaterialType.VIS_CRYSTAL, '3',
		// EnumMultiMaterialType.AQUEOUS_CRYSTAL, '4',
		// EnumMultiMaterialType.EARTHEN_CRYSTAL, '5', "gemDiamond", '6',
		// EnumMultiMaterialType.FIERY_CRYSTAL, '7', "ingotGold", '8',
		// "ingotIron").setVisUsage(15F,
		...
		// addRecipe(new ShapedFuserRecipe(BlocksLT.ADVANCED_VIS_VALVE, " v ",
		// "gcg", " t ", 'v', EnumMultiMaterialType.VIS_CRYSTAL, 't',
		// EnumMultiMaterialType.TAINTED_CRYSTAL, 'g', "ingotGold", 'c',
		// BlocksLT.VIS_VALVE).setResearch(ResearchesLT.ADVANCED_VIS_VALVE).setVisUsage(4.5F,
		// 0));
		...
		// addRecipe(new ShapedFuserRecipe(BlocksLT.REPAIRER, "wiw", "wpw",
		// "wiw", 'w', EnumMultiMaterialType.ENCHANTED_WOOD, 'i', "ingotIron",
		// 'p', EnumMultiMaterialType.ANIMATED_PISTON).setVisUsage(20F,
		// 0).setResearch(ResearchesLT.REPAIRER));
	...
	public List<iFuserRecipe> findRecipes(ItemStack out)
	{
		List<iFuserRecipe> recipes = new ArrayList<>();
		getRecipes().stream().filter(r -> r.getOutput().isItemEqual(out)).forEach(r -> recipes.add(r));
		return recipes;
	}
}